...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZapOpenAPI) DeepCopyInto(out *ZapOpenAPI) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZapOpenAPI.
func (in *ZapOpenAPI) DeepCopy() *ZapOpenAPI {
	if in == nil {
		return nil
	}
	out := new(ZapOpenAPI)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ZapOpenAPI) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZapOpenAPIList) DeepCopyInto(out *ZapOpenAPIList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ZapOpenAPI, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZapOpenAPIList.
func (in *ZapOpenAPIList) DeepCopy() *ZapOpenAPIList {
	if in == nil {
		return nil
	}
	out := new(ZapOpenAPIList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ZapOpenAPIList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZapOpenAPISpec) DeepCopyInto(out *ZapOpenAPISpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZapOpenAPISpec.
func (in *ZapOpenAPISpec) DeepCopy() *ZapOpenAPISpec {
	if in == nil {
		return nil
	}
	out := new(ZapOpenAPISpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZapOpenAPIStatus) DeepCopyInto(out *ZapOpenAPIStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZapOpenAPIStatus.
func (in *ZapOpenAPIStatus) DeepCopy() *ZapOpenAPIStatus {
	if in == nil {
		return nil
	}
	out := new(ZapOpenAPIStatus)
	in.DeepCopyInto(out)
	return out
}
